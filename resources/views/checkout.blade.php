            ...
            @foreach ($orders as $order)
                <div class="row g-3 mb-3">
                    <div class="col-md-4 col-lg-4 col-xs-6 col-sm-12 float-start">
                        <img src="/assets/img/{{ $order->image }}" class="checkout-img">
                    </div>
                    <div class="col-md-8">
                        <div class="barang d-flex justify-content-between">
                            <div class="barang-left">
                            <p class="mb-0">{{ $order->name }}</p>
                            <p class="fw-light mt-0">Jumlah : {{ $order->quantity }}</p>
                            </div>
                            <div class="barang-left d-flex align-items-center">
                            <p class=""><?php $harga = number_format($order->price,0,"","."); echo 'Rp. '.$harga; ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                <hr>
                <?php $subtotal = $subtotal + $order->price ?>
            @endforeach
            <div class="barang d-flex justify-content-between">
                <div class="barang-left">
                ...
                <div class="barang-left d-flex align-items-center">
                    <p class="totalSubProduk"><?php $harga = number_format($subtotal,0,"","."); echo 'Rp. '.$harga; ?></p>
                </div>
            </div>
        </div>
          <div class="col-md-6">
            ...
            <div class="barang d-flex justify-content-between">
              ...
              <div class="barang-left d-flex align-items-center">
                <p class=""><?php $harga = number_format($subtotal,0,"","."); echo 'Rp. '.$harga; ?></p>
              </div>
            </div>
            <hr>
            <div class="barang d-flex justify-content-between ">
              ...
              <div class="barang-left d-flex align-items-center">
                <p id="totalHarga"><?php $harga = number_format($subtotal,0,"","."); echo 'Rp. '.$harga; ?></p>
              </div>
            </div>
